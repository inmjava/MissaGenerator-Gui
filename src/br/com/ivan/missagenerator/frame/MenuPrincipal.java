...
public class MenuPrincipal extends JFrame {
	...
	public void abrirPanel(int qual){
		try {
			Painel panelQual = null;
			switch (qual) {
			case NomePanel.CADASTRO_MOMENTO:
				panelQual = new CadastroMomentos();
				break;
			case NomePanel.CADASTRO_MUSICA:	
				panelQual = new CadastroMusicasPanel();
				break;
			case NomePanel.FAZER_MISSA:
				panelQual = new CriarMissaPanel();
				break;
			case NomePanel.FAZER_MISSA2:
				panelQual = new MissaFreeForm();
				break;
			case NomePanel.MUSICA_MOMENTO:
				panelQual = new MusicaMomentoPanel();
				break;
